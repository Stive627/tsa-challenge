...
function Question({question, moveNext, lastQuestion}) {
  ...
  return (
    <div  className='w-full flex justify-center mt-4'>
      <div className=' w-11/12 lg:w-1/4'>
        ...
        <button onClick={handleClick} className=' float-right cursor-pointer' style={{color:'rgba(181, 23, 158, 1)', fontSize:17}}>{lastQuestion?'Finish':'Next'}</button>
      </div>
    </div>
  )
}
